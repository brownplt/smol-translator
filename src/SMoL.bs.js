...
function toString(it) {
  if (it.TAG === "Plain") {
    ...
    return Caml_splice_call.spliceObjApply("", "concat", [Core__List.toArray(Core__List.map(it._0, (function (param) {
...
function toString$6(t) {
  switch (t.TAG) {
    ...
    case "SExprArityError" :
        return "expecting " + t._1 + ", given " + Caml_splice_call.spliceObjApply(" ", "concat", [Core__List.toArray(Core__List.map(t._2, SExpression.SExpr.toString))]);
  ...
  var p = function (v) {
    switch (v.TAG) {
      ...
      case "Struct" :
          ...
          var content$1;
          content$1 = content.TAG === "Lst" ? "(" + Caml_splice_call.spliceObjApply(" ", "concat", [Core__List.toArray(Core__List.map(content._0, p))]) + ")" : "#(" + Caml_splice_call.spliceObjApply(" ", "concat", [Core__List.toArray(Core__List.map(content._0, p))]) + ")";
...
function printOutput(sepOpt, os) {
  ...
  return Caml_splice_call.spliceObjApply(sep, "concat", [Core__List.toArray(Core__List.map(os, printOutputlet))]);
}
  ...
  var p = function (v) {
    switch (v.TAG) {
      ...
      case "Struct" :
          ...
          content$1 = "[ " + Caml_splice_call.spliceObjApply(", ", "concat", [Core__List.toArray(Core__List.map(content._0, p))]) + " ]";
          return i$1 + content$1;
...
function printOutput$1(sepOpt, os) {
  var sep = sepOpt !== undefined ? sepOpt : " ";
  return Caml_splice_call.spliceObjApply(sep, "concat", [Core__List.toArray(Core__List.map(os, printOutputlet$1))]);
}
  ...
  var p = function (v) {
    switch (v.TAG) {
      ...
      case "Struct" :
          ...
          content$1 = "[" + Caml_splice_call.spliceObjApply(", ", "concat", [Belt_List.toArray(Belt_List.map(content._0, p))]) + "]";
          return i + content$1;
...
function printOutput$2(sepOpt, os) {
  var sep = sepOpt !== undefined ? sepOpt : " ";
  return Caml_splice_call.spliceObjApply(sep, "concat", [Belt_List.toArray(Belt_List.map(os, printOutputlet$2))]);
}
  ...
  var p = function (v) {
    switch (v.TAG) {
      ...
      case "Struct" :
          ...
          content$1 = "vec[" + Caml_splice_call.spliceObjApply(", ", "concat", [Core__List.toArray(Core__List.map(content._0, p))]) + "]";
          return i$1 + content$1;
...
function printOutput$3(sepOpt, os) {
  var sep = sepOpt !== undefined ? sepOpt : " ";
  return Caml_splice_call.spliceObjApply(sep, "concat", [Core__List.toArray(Core__List.map(os, printOutputlet$3))]);
}
  ...
  var p = function (v) {
    switch (v.TAG) {
      ...
      case "Struct" :
          ...
          content$1 = "Buffer(" + Caml_splice_call.spliceObjApply(", ", "concat", [Core__List.toArray(Core__List.map(content._0, p))]) + ")";
          return i + content$1;
...
function printOutput$4(sepOpt, os) {
  var sep = sepOpt !== undefined ? sepOpt : " ";
  return Caml_splice_call.spliceObjApply(sep, "concat", [Core__List.toArray(Core__List.map(os, printOutputlet$4))]);
}
