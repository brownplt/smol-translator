...
import * as RhombusReaderMjs from "./RhombusReader.mjs";
...
function toString$7(t) {
  switch (t.TAG) {
    ...
    case "RhombusParseError" :
        return "expecting a (valid) Rhombus program, but the input is not: " + t._0;
...
function handleVecSet(ctx, ann, e1, e2, e3) {
  var e;
  e = ctx.TAG === "Expr" ? s([
          "",
          "[",
          ...
          if (es) {
            ...
            if (match$1 && !match$1.tl) {
              ...
              return {
                      ...
                      ann: handleVecSet(ctx, ann, e1$3.ann.print, {
                            it: {
                              TAG: "Plain",
                              _0: "0"
                            },
          ...
          if (es) {
            ...
            if (match$2 && !match$2.tl) {
              ...
              return {
                      ...
                      ann: handleVecSet(ctx, ann, e1$4.ann.print, {
                            it: {
                              TAG: "Plain",
                              _0: "1"
                            },
            ...
            if (match$4) {
              ...
              if (match$5 && !match$5.tl) {
                ...
                return {
                        ...
                        ann: handleVecSet(ctx, ann, e1$6.ann.print, e2$4.ann.print, e3.ann.print)
                      };
              }
...
function exprSetToString$1(x, e, ctx) {
  if (ctx.TAG === "Expr") {
    return {
            TAG: "Group",
            _0: {
...
function collectMutated(p) {
    ...
    while(true) {
      ...
      switch (it.TAG) {
        ...
        case "Lam" :
            return block(it._1);
        case "Let" :
            Belt_List.forEach(it._1, (function (param) {
                    expression(param.it[1]);
                  }));
            return block(it._2);
        case "AppPrm" :
            var exit = 0;
        ...
        case "And" :
        case "Or" :
            return Belt_List.forEach(it._0, expression);
        case "Cnd" :
            Belt_List.forEach(it._0, (function (param) {
                    expression(param[0]);
                    block(param[1]);
                  }));
            return Belt_Option.forEach(it._1, block);
        case "Yield" :
            _param = it._0;
            continue ;
        case "App" :
  ...
  var block = function (_param) {
    while(true) {
      var param = _param;
      var it = param.it;
      if (it.TAG === "BRet") {
        return expression(it._0);
      }
      term(it._0);
      _param = it._1;
      continue ;
...
function consumeContext$3(ctx, ann, e) {
  var e$1 = ann(e);
  if (ctx.TAG === "Expr") {
    return e$1;
  } else {
...
function consumeContextWrap$4(ctx, ann, e) {
  if (ctx.TAG === "Expr") {
    if (ctx._0) {
      return ann(paren$4(e));
    } else {
      return ann(e);
    }
  } else {
...
function exprAppPrmToString$4(ann, ctx, p, es) {
  var infix = function (op, es) {
    var es$1 = Belt_List.map(es, (function (e) {
            return e(true);
          }));
    return {
            ...
            ann: consumeContextWrap$4(ctx, ann, concat(" " + op + " ", Belt_List.map(es$1, (function (e) {
                            return e.ann.print;
                          }))))
          };
  };
  if (typeof p !== "object") {
    switch (p) {
      ...
      case "PairSetRight" :
          throw {
                RE_EXN_ID: SMoLPrintError,
                _1: "Rhombus pairs are immutable, so `set-left!` and `set-right!` have no form.",
                Error: new Error()
              };
      case "VecRef" :
          if (es) {
            ...
            if (match && !match.tl) {
              ...
              return {
                      ...
                      ann: consumeContext$3(ctx, ann, s([
                                "",
                                "[",
                                "]"
                              ], [
            ...
            if (match$1) {
              ...
              if (match$2 && !match$2.tl) {
                ...
                return {
                        ...
                        ann: consumeContextWrap$4(ctx, ann, s([
                                  "",
                                  "[",
                                  "] := ",
                                  ""
      ...
      case "Next" :
          throw {
                RE_EXN_ID: SMoLPrintError,
                _1: "Generators are not supported by Rhombus.",
                Error: new Error()
              };
      case "StringAppend" :
          return infix("++", es);
    ...
    if (exit === 2) {
      return infix(stringOfArith$4(o), es);
    }
    
  } else if (es) {
    var match$3 = es.tl;
    if (match$3 && !match$3.tl) {
      return infix(stringOfCmp$4(p._0), {
                  hd: es.hd,
                  tl: {
                    hd: match$3.hd,
                    tl: /* [] */0
  ...
  if (name !== undefined) {
    ...
    return {
            ...
            ann: consumeContext$3(ctx, ann, exprAppToString$4({
                      it: {
                        TAG: "Plain",
                        _0: name
                      },
                      ann: undefined
                    }, Belt_List.map(es$1, (function (e) {
                            return e.ann.print;
                          }))))
          };
  }
  var err = "Rhombus doesn't let you use " + toString$1(p) + " on " + String(Belt_List.length(es)) + " parameter(s).";
  throw {
        RE_EXN_ID: SMoLPrintError,
        _1: err,
        Error: new Error()
...
function defvarToString$5(x, name, e) {
  var it = binderOf("def", name);
  return s([
              "",
              " ",
              " = ",
...
function exprBlockStatToString(b) {
  return s([
              "block:",
              ""
            ], [indentBlock(b, 2)]);
...
function exprWhileToString$2(cnd, body, inStat) {
  if (inStat) {
    return s([
                "while ",
                ":",
  ...
  switch (it.TAG) {
    case "Con" :
        ...
        return {
                ...
                ann: {
                  sourceLocation: sourceLocation,
                  print: consumeContext$3(ctx, ann, {
                        TAG: "Plain",
    ...
    case "Set" :
        ...
        return {
                ...
                ann: {
                  sourceLocation: sourceLocation,
                  print: consumeContextWrap$4(ctx, ann, exprSetToString$5(x$1.ann.print, e.ann.print))
                }
              };
    case "Lam" :
    ...
    case "Let" :
        ...
        var names = Belt_List.map(xes, (function (param) {
                return parameterPrint(symbolToString$5(param.it[0]));
              }));
        var keyword;
        switch (k) {
          case "Plain" :
    ...
    case "App" :
        ...
        return {
                ...
                ann: {
                  sourceLocation: sourceLocation,
                  print: consumeContext$3(ctx, ann, exprAppToString$4(e$1.ann.print, Belt_List.map(es$1, (function (e) {
                                  return e.ann.print;
                                }))))
                }
              };
    ...
    case "And" :
        var es$3 = Belt_List.map(it._0, (function (e) {
                return printExp$5(e, {
                            TAG: "Expr",
                            _0: true
                          });
        ...
        return {
                ...
                ann: {
                  sourceLocation: sourceLocation,
                  print: consumeContextWrap$4(ctx, ann, concat(" && ", Belt_List.map(es$3, (function (e) {
                                  return e.ann.print;
                                }))))
                }
              };
    case "Or" :
        var es$4 = Belt_List.map(it._0, (function (e) {
                return printExp$5(e, {
                            TAG: "Expr",
                            _0: true
                          });
        ...
        return {
                ...
                ann: {
                  sourceLocation: sourceLocation,
                  print: consumeContextWrap$4(ctx, ann, concat(" || ", Belt_List.map(es$4, (function (e) {
                                  return e.ann.print;
                                }))))
                }
              };
    ...
    case "Yield" :
        throw {
              RE_EXN_ID: SMoLPrintError,
              _1: "`yield` is not supported by Rhombus.",
              Error: new Error()
            };
    case "While" :
        var e_cnd$1 = printExp$5(it._0, {
              TAG: "Expr",
              _0: false
            });
        var es_thn = Belt_List.map(it._1, (function (e_thn) {
                return printExp$5(e_thn, {
                            TAG: "Stat",
                            _0: "Step"
                          });
              }));
  ...
  switch (d.TAG) {
    case "Var" :
        ...
        return {
                ...
                ann: {
                  sourceLocation: sourceLocation,
                  print: annPrint(defvarToString$5(x$1.ann.print, name, e.ann.print))
                }
              };
    case "Fun" :
        var f = symbolToString$5(d._0);
        var xs = Belt_List.map(d._1, symbolToString$5);
        var b = printBlock$5(d._2, {
              TAG: "Stat",
              _0: "Return"
            });
        return {
                ...
                ann: {
                  sourceLocation: sourceLocation,
                  print: annPrint(deffunToString$5(f.ann.print, Belt_List.map(xs, parameterPrint), b.ann.print))
                }
              };
    case "GFun" :
        throw {
...
function printBlockHelper$3(param, ctx, joiner) {
  var sourceLocation = param.ann;
  var b = param.it;
  var annPrint = function (print) {
    return {
  ...
  var b$1 = printBlockHelper$3(b._1, ctx, joiner);
  var print = annPrint(s([
            "",
            "",
            "",
...
function printBlock$5(b, ctx) {
  if (ctx.TAG === "Expr") {
    return printBlockHelper$3(b, {
                TAG: "Expr",
                _0: ctx._0
              }, "; ");
  } else {
  ...
  var p = function (v) {
    switch (v.TAG) {
      ...
      case "Struct" :
          var content = v._1;
          if (content.TAG === "Lst") {
            return "[" + Belt_List.toArray(Belt_List.map(content._0, p)).join(", ") + "]";
          } else {
            return "Array(" + Belt_List.toArray(Belt_List.map(content._0, p)).join(", ") + ")";
          }
...
function init(prim) {
  return RhombusReaderMjs.init();
}

function isReady(prim) {
  return RhombusReaderMjs.isReady();
}

var Malformed = /* @__PURE__ */Caml_exceptions.create("SMoL.RhombusParser.Malformed");

function malformed(what, json) {
  throw {
        RE_EXN_ID: Malformed,
        _1: "expecting " + what + ", given " + JSON.stringify(json),
        Error: new Error()
      };
}
...
function asObject(json) {
  if (!Array.isArray(json) && (json === null || typeof json !== "object") && typeof json !== "number" && typeof json !== "string" && typeof json !== "boolean" || !(typeof json === "object" && !Array.isArray(json))) {
    return malformed("an object", json);
  } else {
    return json;
  }
}
...
function asArray(json) {
  if (!Array.isArray(json) && (json === null || typeof json !== "object") && typeof json !== "number" && typeof json !== "string" && typeof json !== "boolean" || !Array.isArray(json)) {
    return malformed("an array", json);
  } else {
    return json;
  }
}
...
function asString(json) {
  if (!Array.isArray(json) && (json === null || typeof json !== "object") && typeof json !== "number" && typeof json !== "string" && typeof json !== "boolean" || typeof json !== "string") {
    return malformed("a string", json);
  } else {
    return json;
  }
}

function asFloat(json) {
  if (!Array.isArray(json) && (json === null || typeof json !== "object") && typeof json !== "number" && typeof json !== "string" && typeof json !== "boolean" || typeof json !== "number") {
    return malformed("a number", json);
  } else {
    return json;
  }
}
...
function asBool(json) {
  if (!Array.isArray(json) && (json === null || typeof json !== "object") && typeof json !== "number" && typeof json !== "string" && typeof json !== "boolean" || typeof json !== "boolean") {
    return malformed("a boolean", json);
  } else {
    return json;
  }
}

function field(json, name) {
  var value = asObject(json)[name];
  if (value !== undefined) {
    return value;
  } else {
    return malformed("a \"" + name + "\" field", json);
  }
}

function tag(json) {
  return asString(field(json, "tag"));
}

function list(json, decode) {
  return Core__List.map(Core__List.fromArray(asArray(json)), decode);
}

function sourcePoint(json) {
  return {
          ln: asFloat(field(json, "ln")) | 0,
          ch: asFloat(field(json, "ch")) | 0
        };
}

function sourceLocation(json) {
  return {
          begin: sourcePoint(field(json, "begin")),
          end: sourcePoint(field(json, "end"))
        };
}

function annotated(json, decode) {
  return {
          it: decode(field(json, "it")),
          ann: sourceLocation(field(json, "ann"))
        };
}

function symbol(json) {
  return annotated(json, asString);
}

function constant(json) {
  var other = tag(json);
  switch (other) {
    case "Lgc" :
        return {
                TAG: "Lgc",
                _0: asBool(field(json, "value"))
              };
    case "Nil" :
        return "Nil";
    case "Num" :
        return {
                TAG: "Num",
                _0: asFloat(field(json, "value"))
              };
    case "Str" :
        return {
                TAG: "Str",
                _0: asString(field(json, "value"))
              };
    case "Sym" :
        return {
                TAG: "Sym",
    ...
    case "Uni" :
        return "Uni";
    default:
      return malformed("a constant, not \"" + other + "\"", json);
  }
}
...
function primitive(json) {
  ...
  switch (other) {
    ...
    case "ZeroP" :
        return "ZeroP";
    default:
      return malformed("a primitive, not \"" + other + "\"", json);
  }
}

function letKind(json) {
  var other = tag(json);
  switch (other) {
    case "Nested" :
        return "Nested";
    ...
    case "Recursive" :
        return "Recursive";
    default:
      return malformed("a let kind, not \"" + other + "\"", json);
  }
}

function expression(json) {
  return annotated(json, expressionNode);
}

function expressionNode(json) {
  var other = tag(json);
  switch (other) {
    case "And" :
        return {
                TAG: "And",
                _0: list(field(json, "exps"), expression)
              };
    case "App" :
        return {
                TAG: "App",
                _0: annotated(field(json, "func"), expressionNode),
                _1: list(field(json, "args"), expression)
              };
    case "AppPrm" :
        return {
                TAG: "AppPrm",
                _0: primitive(field(json, "prim")),
                _1: list(field(json, "args"), expression)
              };
    case "Bgn" :
        return {
                TAG: "Bgn",
                _0: list(field(json, "exps"), expression),
                _1: annotated(field(json, "result"), expressionNode)
              };
    case "Cnd" :
        var els = field(json, "els");
        var tmp;
        tmp = !Array.isArray(els) && (els === null || typeof els !== "object") && typeof els !== "number" && typeof els !== "string" && typeof els !== "boolean" ? undefined : annotated(els, blockNode);
        return {
                TAG: "Cnd",
                _0: list(field(json, "clauses"), clause),
                _1: tmp
              };
    case "Con" :
        return {
                TAG: "Con",
                _0: constant(field(json, "value"))
              };
    case "If" :
        return {
                TAG: "If",
                _0: annotated(field(json, "cnd"), expressionNode),
                _1: annotated(field(json, "thn"), expressionNode),
                _2: annotated(field(json, "els"), expressionNode)
              };
    case "Lam" :
        return {
                TAG: "Lam",
                _0: list(field(json, "params"), symbol),
                _1: annotated(field(json, "body"), blockNode)
              };
    case "Let" :
        return {
                TAG: "Let",
                _0: letKind(field(json, "kind")),
                _1: list(field(json, "binds"), bind),
                _2: annotated(field(json, "body"), blockNode)
              };
    case "Or" :
        return {
                TAG: "Or",
    ...
    case "Ref" :
        return {
                TAG: "Ref",
                _0: asString(field(json, "name"))
              };
    case "Set" :
        return {
                TAG: "Set",
                _0: annotated(field(json, "name"), asString),
                _1: annotated(field(json, "value"), expressionNode)
              };
    case "While" :
        return {
                TAG: "While",
                _0: annotated(field(json, "cnd"), expressionNode),
                _1: list(field(json, "body"), expression)
              };
    case "Yield" :
        return {
                TAG: "Yield",
                _0: annotated(field(json, "value"), expressionNode)
              };
    default:
      return malformed("an expression, not \"" + other + "\"", json);
  }
}

function clause(json) {
  var match = asArray(json);
  if (match.length !== 2) {
    return malformed("a two-element cond clause", json);
  }
  var test = match[0];
  var body = match[1];
  return [
          annotated(test, expressionNode),
          annotated(body, blockNode)
        ];
}

function bind(json) {
  return annotated(json, (function (node) {
                var match = asArray(node);
                if (match.length !== 2) {
                  return malformed("a two-element binding", node);
                }
                var name = match[0];
                var value = match[1];
                return [
                        annotated(name, asString),
                        annotated(value, expressionNode)
                      ];
              }));
}

function blockNode(json) {
  var other = tag(json);
  switch (other) {
    case "BCons" :
        return {
                TAG: "BCons",
                _0: annotated(field(json, "head"), termNode),
                _1: annotated(field(json, "tail"), blockNode)
              };
    case "BRet" :
        return {
                TAG: "BRet",
    ...
    default:
      return malformed("a block, not \"" + other + "\"", json);
  }
}

function definitionNode(json) {
  var other = tag(json);
  switch (other) {
    case "Fun" :
        return {
                TAG: "Fun",
                _0: annotated(field(json, "name"), asString),
                _1: list(field(json, "params"), symbol),
                _2: annotated(field(json, "body"), blockNode)
              };
    case "GFun" :
        return {
    ...
    default:
      return malformed("a definition, not \"" + other + "\"", json);
  }
}

function termNode(json) {
  var other = tag(json);
  switch (other) {
    case "Def" :
        return {
                TAG: "Def",
                _0: annotated(field(json, "def"), definitionNode)
              };
    case "Exp" :
        return {
                TAG: "Exp",
                _0: annotated(field(json, "exp"), expressionNode)
              };
    default:
      return malformed("a term, not \"" + other + "\"", json);
  }
}

function programNode(json) {
  var other = tag(json);
  switch (other) {
    case "PCons" :
        return {
                TAG: "PCons",
                _0: annotated(field(json, "head"), termNode),
                _1: annotated(field(json, "tail"), programNode)
              };
    case "PNil" :
        return "PNil";
    default:
      return malformed("a program, not \"" + other + "\"", json);
  }
}

function parseProgram$1(src) {
  if (!RhombusReaderMjs.isReady()) {
    throw {
          RE_EXN_ID: SMoLParseError,
          _1: {
            TAG: "RhombusParseError",
            _0: "the Rhombus reader is not initialised: await RhombusReader.init() first"
          },
          Error: new Error()
        };
  }
  ...
  var text;
  try {
    text = RhombusReaderMjs.parseProgramJson(src);
    exit = 1;
  }
  catch (raw_err){
    var err = Caml_js_exceptions.internalToOCamlException(raw_err);
    if (err.RE_EXN_ID === Js_exn.$$Error) {
      var err$1 = {
        TAG: "RhombusParseError",
        _0: Core__Option.getOr(err._1.message, "the Rhombus reader failed")
      };
      throw {
            RE_EXN_ID: SMoLParseError,
            _1: err$1,
  ...
  var message;
  try {
    message = field(json, "error");
  }
  catch (raw_exn){
    var exn = Caml_js_exceptions.internalToOCamlException(raw_exn);
    if (exn.RE_EXN_ID === Malformed) {
      try {
        return annotated(field(json, "ok"), programNode);
      }
      catch (raw_why){
        var why = Caml_js_exceptions.internalToOCamlException(raw_why);
        if (why.RE_EXN_ID === Malformed) {
          throw {
                RE_EXN_ID: SMoLParseError,
                _1: {
                  TAG: "RhombusParseError",
...
function translateOutput$1(src, sepOpt) {
  ...
  try {
    return printOutput$5(sep, output);
  }
  catch (raw_err$1){
    var err$1 = Caml_js_exceptions.internalToOCamlException(raw_err$1);
    if (err$1.RE_EXN_ID === SMoLPrintError) {
...
function translateOutput$5(src, sepOpt) {
  var sep = sepOpt !== undefined ? sepOpt : " ";
  var output;
  try {
    output = parseOutput(src);
...
function parseProgramIn(input, src) {
  var parse;
  switch (input) {
    case "SMoL" :
        parse = parseProgram;
    ...
    default:
      throw {
            ...
            _1: {
              TAG: "KindError",
              _0: toString$12(input) + " programs cannot be read, only printed."
            },
            Error: new Error()
          };
  }
...
function translateProgram$6(input, output, insertPrintTopLevel, src) {
  var p = parseProgramIn(input, src);
  var P = printerOf(output);
  try {
    return P.printProgram(insertPrintTopLevel, p);
  }
  catch (raw_err){
    var err = Caml_js_exceptions.internalToOCamlException(raw_err);
    if (err.RE_EXN_ID === SMoLPrintError) {
      throw {
            RE_EXN_ID: SMoLTranslateError,
            _1: {
              TAG: "PrintError",
...
function translateProgramFull$6(input, output, insertPrintTopLevel, src) {
  var p = parseProgramIn(input, src);
  var P = printerOf(output);
  try {
    return P.printProgramFull(insertPrintTopLevel, p);
  }
  catch (raw_err){
    var err = Caml_js_exceptions.internalToOCamlException(raw_err);
    if (err.RE_EXN_ID === SMoLPrintError) {
...
function translateOutput$6(output, sepOpt, src) {
  var sep = sepOpt !== undefined ? sepOpt : " ";
  var os;
  try {
    os = parseOutput(src);
...
export {
  ...
  Language ,
  parseProgramIn ,
  translateProgram$6 as translateProgram,
  translateProgramFull$6 as translateProgramFull,
  translateOutput$6 as translateOutput,
}
