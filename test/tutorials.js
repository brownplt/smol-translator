export const tutorials = {
    ...
    "def3":
    {
        ...
        "questions": {
            "bad_order": {
                ...
                "misconceptions": {
                    "3 2": {
                        "feedback": "You might think `(+ y 1)` is able to refer to `y` and hence evaluate to a value.\nHowever, although it is able to refer to `y`, `y` has not been bound to a value\nat that moment.\nIn general, every block evaluates its definitions and expressions in the reading order (i.e., top-to-bottom and left-to-right), and it is an error to evaluate a variable reference before binding the variable to a value.\n",
                        "misconception": "Lazy"
                    }
                }
            },
            "defvar_binding_cause_evaluation": {
                ...
                "misconceptions": {
                    "3": {
                        "feedback": "You might think `(/ 12 0)` is not evaluated because `x` is not needed.\nHowever, this is not the case.\nIn general, every variable definition evaluates the expression immediately and binds the variable to the value, even if the variable is not used later in the program.\n",
                        "misconception": "Lazy"
                    }
                }
            },
    ...
    "vectors1":
    {
        ...
        "questions": {
            ...
            "warmup_vecref": {
                "answer": "63",
                "feedback": "Recall that the left-most element is the 0-th (rather than 1-th!) element.\n`(vec-ref v 1)` produces the value of `(mvec 63 64)`.\nSo, `(vec-ref vr 0)` produces `63`.\n",
                "program": "(defvar v (mvec (mvec 61 62) (mvec 63 64)))\n(defvar vr (vec-ref v 1))\n(vec-ref vr 0)\n",
                "again": {
                    "answer": "88",
            ...
            "warmup_vecset": {
                ...
                "misconceptions": {
                    "92 73": {
                        "feedback": "`x` is bound to a vector.\nA vector containing `92` and `73` is printed as `#(92 73)`.\n",
                        "misconception": "Other"
                    }
                }
            }
    ...
    "vectors2":
    {
        ...
        "questions": {
            "alias_mvec_in_mpair": {
                ...
                "program": "(defvar v (mvec 71 72 73))\n(defvar vv (mvec v v))\n(vec-set! (vec-ref vv 1) 0 44)\n(vec-ref vv 0)\n",
                "again": {
                    "answer": "#(42)",
                ...
                "misconceptions": {
                    "#(71 72 73)": {
                        "feedback": "You might think the two elements of `v` refer to different vectors, so changing one doesn't change the other.\nHowever, they refer to the same vector.\nIn general, a vector can be referred to by multiple places, and creating a new vector (which is essentially a function call) does not create new copies of the elements.\n\n`(mvec v v)` creates only one new vector. Both elements of this new vector refer to the same vector as `v`.\n",
            ...
            "alias_with_defvar": {
                ...
                "misconceptions": {
                    "#(77)": {
                        "feedback": "You might think `x` and `y` refer to different vectors, so changing `x` doesn't change `y`.\nHowever, they refer to the same vector.\nIn general, a vector can be referred to by more than one variable, and variable definitions do not create new vectors.\n",
            ...
            "alias_with_funcall": {
                ...
                "misconceptions": {
                    "#(71 86)": {
                        "feedback": "You might think `x` and `y` refer to different vectors, so changing `y` doesn't change `x`.\nHowever, they refer to the same vector.\nIn general, a vector can be referred to by more than one variable, and function calls do not create new vectors.\n",
            ...
            "basic_circularity": {
                ...
                "misconceptions": {
                    "error": {
                        "feedback": "You might think `x` can't refer to itself.\nHowever, this is not the case.\nIn general, vectors can be referred to by arbitrary vectors, including themselves.\n",
            ...
            "new_alias_with_defvar": {
                "answer": "#(34)",
                "feedback": "`x` is first bound to a vector that contains `62`. `y` is bound to the same vector.\nThe vector mutation replaces `62` with `34`. So, eventually, the vector becomes `#(34)`.\n",
