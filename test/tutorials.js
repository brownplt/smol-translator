...
tutorials["scope"] = {
    ...
    "order": [
        ...
        "define_twice_arg",
        "goal_define_twice",
        "goal_lexical_scope_labelling_keyframe"
    ],
    "questions": {
        "define_block": {
        ...
        "goal_lexical_scope_labelling_keyframe": {
            "confirm": "Here is a program that you have seen\n\n```\n(defvar x 1)\n(deffun (get-x) x)\n\n(deffun (main)\n  (defvar x 2)\n  (get-x))\n(main)\n```\n\nPlease\n\n1. Run this program in DrRacket (Please copy the program with the “COPY as program” button. It will insert a line at the beginning of the program. The line tells DrRacket that you are using a SMoL language.);\n2. DrRacket should show you a window that shows how this program produces `1`;\n3. Take 1 screenshot of the window that you find particularly helpful;\n4. Submit your screenshots <a href='https://forms.gle/QRWTE79PEXg7EM8x5' target='_blank'>here</a>, and fill in the rest of the form.\n"
        },
        "goal_undefined": {
...
tutorials["order"] = {
    ...
    "order": [
        ...
        "goal_order_of_computation_keyframe"
    ],
    "questions": {
        "bad_order": {
            "answer": "error",
        ...
        "goal_order_of_computation": {
            "emphasize": "1. Every `defvar` evaluates the expression immediately and binds the variable to the value, even if the variable is not used later in the program.\n2. Every function call evaluates the actual parameters immediately and binds the values to formal parameters, even when the formal parameter is not used in the function.\n3. A sequence of `defvar` and `deffun` binds the variables to the values in top-to-bottom, left-to-right order.\n4. It is an error to evaluate a variable reference before binding it to a value.\n"
        },
        "goal_order_of_computation_keyframe": {
            "confirm": "Here is a program that you may have seen\n\n```\n(deffun (addy x)\n  (+ x y))\n(defvar s (addy 1))\n(defvar y 2)\ns\n```\n\nPlease\n\n1. Run this program in DrRacket;\n2. DrRacket should show you a window that shows how this program errors;\n3. Take 1 screenshot of the window that you find particularly helpful;\n4. Submit your screenshots <a href='https://forms.gle/w9z9nTjJFnR6P889A' target='_blank'>here</a>, and fill in the rest of the form.\n"
        },
        "goal_order_of_computation_labelling_1": {
...
tutorials["mut-vars"] = {
    ...
    "order": [
        ...
        "attention_check1",
        "attention_check2",
        "goal_mutable_variables_keyframe"
    ],
    "questions": {
        "attention_check1": {
            "checkboxes": [
                [
                    true,
                    "Definitions (i.e., `defvar` and `deffun`)"
                ],
                [
                    false,
                    "Variable mutations (i.e., `set!`)"
                ],
                [
                    false,
                    "Variable references"
        ...
        "goal_mutable_variables_keyframe": {
            "confirm": "Here is a program that confused many students in previous years.\n\n```\n(defvar x 5)\n(deffun (set1 x y)\n  (set! x y))\n(set1 x 6)\nx\n```\n\nPlease\n\n1. Run this program in DrRacket;\n2. DrRacket should show you a window that shows how this program produces the result;\n3. Take 1 screenshot of the window that you find particularly helpful;\n4. Submit your screenshots <a href=\"https://forms.gle/gXVpyoefdu3qLnh77\" target=\"_blank\">here</a>, and fill in the rest of the form.\n"
        },
        "goal_mutvars": {
            "emphasize": "1. Which variable (if any) a `set!` mutates is dictated by scope.\n2. Using `set!` to mutate a variable (e.g., `y`) won’t mutate the binding of other variables (e.g., `x`), no matter how the definition of the first variable is related to the second variable (e.g., given `(defvar y x)`, mutating either `x` or `y` will not mutate the other).\n"
        },
        "goal_mutvars_labelling_1": {
...
tutorials["vectors1"] = {
    ...
    "questions": {
        ...
        "warmup_vecset_1": {
            "answer": "'#(10 3)",
            "feedback": "`x` is bound to a vector.\nThe initial content of the vector is `2` and `3`.\nThe `vec-set!` mutates the first element to `10`.\nA vector containing `10` and `3` is printed as `'#(10 3)`.\n",
        ...
        "warmup_vecset_2": {
            "answer": "'#(10)",
            "feedback": "`x` is bound to a vector.\nThe initial content of the vector is `2`.\nThe `vec-set!` mutates the content to `10`.\nA vector containing `10` is printed as `'#(10)`.\n",
...
tutorials["vectors2"] = {
    ...
    "questions": {
        ...
        "alias_with_defvar": {
            ...
            "program": "(defvar x (mvec 12))\n(defvar y x)\n(vec-set! x 0 34)\ny\n",
            "again": {
                "answer": "'#(3 17)",
                "program": "(defvar var1 (mvec 3 2))\n(defvar var2 var1)\n(vec-set! var1 1 17)\nvar2\n"
            },
            "misconceptions": {
                "'#(12)": {}
            }
        ...
        "alias_with_funcall": {
            ...
            "again": {
                "answer": "'#(20 17)",
                "program": "(defvar var1 (mvec 10 17))\n(deffun (update-var var2)\n  (vec-set! var2 0 20))\n(update-var var1)\nvar1\n"
            },
            "misconceptions": {
                "'#(1 0)": {}
            }
        ...
        "stacker_exercise": {
            "confirm": "Here is a program that confused many students in previous years.\n\n```\n(defvar v (mvec 1 2 3 4))\n(defvar vv (mvec v v))\n(vec-set! (vec-ref vv 1) 0 100)\nvv\n```\n\nPlease\n\n1. Run this program in DrRacket;\n2. DrRacket should show you a window that shows how this program produces the result;\n3. Take 1 screenshot of the window that you find particularly helpful;\n4. Submit your screenshots <a href=\"https://forms.gle/WokoDNyQM5GqoE4J8\" target=\"_blank\">here</a>, and fill in the rest of the form.\n"
        },
        "warmup_circularity": {
            "answer": "3",
...
tutorials["lambda3"] = {
    ...
    "questions": {
        ...
        "stacker_exercise": {
            "confirm": "Here is a program that you have seen\n\n```\n(deffun (make-counter count)\n  (deffun (counter)\n    (set! count (+ count 1))\n    count)\n  counter)\n(defvar f (make-counter 0))\n(defvar g (make-counter 0))\n\n(f)\n(f)\n(g)\n```\n\nPlease\n\n1. Run this program in DrRacket;\n2. DrRacket should show you a window that shows how this program produces the result;\n3. Take 1 screenshot of the window that you find particularly helpful;\n4. Submit your screenshots <a href=\"https://forms.gle/7CUzWC1gkKKmVCUeA\" target=\"_blank\">here</a>, and fill in the rest of the form.\n"
        }
    }
};
tutorials["local"] = {
...
tutorials["demo"] = {
    ...
    "questions": {
        "goal_mutable_variables_keyframe": {
            "confirm": "Here is a program that confused many students in previous years.\n\n```\n(defvar x 5)\n(deffun (set1 x y)\n  (set! x y))\n(set1 x 6)\nx\n```\n\nPlease\n\n1. Run this program in DrRacket;\n2. DrRacket should show you a window that shows how this program produces the result;\n3. Take 1 screenshot of the window that you find particularly helpful;\n4. Submit your screenshots <a href=\"https://docs.google.com/forms/d/e/1FAIpQLSdzC8_JVONoyus9TkB20IZwtrfwW5HLb8LcGf695HxtefbjbA/viewform?usp=sf_link\" target=\"_blank\">here</a>, and fill in the rest of the form.\n"
        },
        "goal_mutvars": {
            "emphasize": "1. Which variable (if any) a `set!` mutates is dictated by scope.\n2. Using `set!` to mutate a variable (e.g., `y`) won’t mutate the binding of other variables (e.g., `x`), no matter how the definition of the first variable is related to the second variable (e.g., given `(defvar y x)`, mutating either `x` or `y` will not mutate the other).\n"
        },
